...
<head>
    ...
    <title>Jump Starter - Create thes Cases</title>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-8 offset-md-4">
                        <div class="card">
                            <div class="header">
                                <h4 class="title"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Edit your profile</font></font></h4>
                            </div>
                            <div class="content">
                                <form>
                                    <div class="row">
                                    ...
                                    <button type="submit" class="btn btn-info btn-fill pull-right"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Update profile</font>
                                    </font></button>
